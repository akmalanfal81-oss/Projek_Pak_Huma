...
<header>
    ...
    <nav class="header-nav">
        ...
        <!-- MENU BARU: Link Profil Perusahaan -->
        ...
        ?>
            <!-- Memberikan margin-left pada Riwayat agar ada jarak dari menu Profil Perusahaan -->
            <a href="riwayat.php" style="color: var(--dark); font-weight: 600; text-decoration: none; font-size: 0.95rem; border-right: 2px solid var(--border); padding-right: 15px; margin-left: 15px;">Riwayat Pesanan</a>

            <a href="profil.php" class="header-profile-link" style="margin-left: 15px;">
        ...
        <?php else: ?>
            <a href="login.php" class="header-login-link" style="margin-left: 15px;">Login</a>
        <?php endif; ?>
